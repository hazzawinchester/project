...
king = xmpz(int("0b1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111",2))
print(bin(king))
raise gmpy2.OverflowResultError
