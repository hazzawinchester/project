...
def create_board(layout="rnbqkbnr/pppppppp/8/3n4/5Q2/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", piece_type="classic", game_type="p", colour_scheme=["#e2bd8d","#421e00"]):#"#e2bd8d","#421e00"
    global chessboard
