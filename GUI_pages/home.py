...
class Home_page(tk.Frame):
    def __init__(self,master):
        ...
        header = tk.Label(self, text = "CHESSCAPE", font = ("arial",20),bg="#5b5b5b",borderwidth=0)
        ...
        tk.Button(frame,bg = "Blue",fg ="White",width=20, height= 2, font= ("arial",20),text = "play", command = lambda : (self.master.show_frame("Play"), self.master.frames["Play"].create_board(),self.master.lastpage.append("Home"))).pack(anchor="center",pady=50)
