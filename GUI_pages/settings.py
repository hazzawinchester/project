...
class Settings_page(tk.Frame):
    def __init__(self,master):
        ...
        #self.colour_scheme = {"white":"#e2bd8d","black":"#300659"}
        ...
        self.example_board = Temp_board(frame,{"white":"#300659","black":"#e2bd8d"})
    ...
    def reset_settings(self):
        ...
        self.black_colour.insert(tk.END, "#300659")
        self.example_board.colour_scheme = {"white":"#300659","black":"#e2bd8d"}
